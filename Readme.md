...
The code is implemented using **MATLAB R2016b (version 9.1)**, and all the experiments are executed on a laptop having an Intel(R) Core(TM) i5-3210M CPU @ 2.50GHz   2.50GHz, 6 GB of memory, 750 GB of HDD, and a Windows 7 Ultimate (Service Pack 1) operating system. There are two independent versions of implementation, each equipped with a sophisticated GUI:
