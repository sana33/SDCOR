...
* #### There are two videos for both [RAM version](/videos/SDCOR_RAMversion.wmv) and [Disk version](/videos/SDCOR_DiskVersion.wmv), which each of them demonstrates a test run of the corresponding implementation.
  ...
  * #### If the process of a GUI gets so long and intolerable, or if for any kind of reason you want to cease the operation, you can click in the __Command Window__ of MATLAB and press __Ctrl+C__ or __Ctrl+Break__.
